...
All our packages have github actions by default, so you can test your [contribution](https://github.com/yiisoft/translator-message-db/blob/master/.github/CONTRIBUTING.md) in the cloud.
